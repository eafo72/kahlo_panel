...
const Asistencia = () => {
  ...
  const COLUMNS = [
    ...
    {
      Header: "Minutos Retraso",
      accessor: "minutos_retraso",
      Cell: (row) => {
        return <span>{row?.cell?.value}</span>;
      },
    },
  ...
  const getInfo = async () => {
    try {
        const res = await clienteAxios.get(`/venta/autorizaciones/asistencia`);
    ...
    <>
      <Card noborder>
        <div className="md:flex justify-between items-center mb-6">
          <h4 className="card-title">Asistencia</h4>
