...
const ToursEditarSalida = () => {
  ...
  const id = localStorage.getItem("EditSalidaTour");

  //getSalida
  const getSalida = async () => {
    try {
      const res = await clienteAxios.get("/admin/fecha-tour/obtener/" + id);
      setDia({
...
export default ToursEditarSalida;
